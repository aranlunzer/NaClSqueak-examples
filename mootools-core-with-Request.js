...
web build:
 - http://mootools.net/core/809a30e81f97304c7fff4cd146b7bef9

packager build:
 - packager build Core/Event Core/Element.Dimensions Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions Core/Request.JSON Core/DOMReady
